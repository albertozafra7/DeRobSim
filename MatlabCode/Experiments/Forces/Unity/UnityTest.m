...
%% Data Conversion
%hdf52mat('D:\alber\Documents\Cosas de la Universidad\Apuntes\Master\Internships\DeRobSim\ThirdParty\TFG_Robotarium\CodigoPropio\Experiments\Forces\Unity\CubeTestForce.h5');
load('D:\alber\Documents\Cosas de la Universidad\Apuntes\Master\Internships\DeRobSim\ThirdParty\TFG_Robotarium\CodigoPropio\Experiments\Forces\Unity\CubeTestForce.mat');

%% Data Preparation
defCube = Unity("DeformableCube");
particleInfo = defCube("particles_info");
vertexInfo = defCube("vertex_info");

n_times = length(times);
n_vertices = defCube("n_vertices");
n_vertices = n_vertices(1);
n_particles = defCube("n_particles");

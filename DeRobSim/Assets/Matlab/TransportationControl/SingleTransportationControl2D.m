...
function [ single_accel ] = SingleTransportationControl2D(robot_id, positions, destinations, prev_pos, k1H, k2H, k1G, k2G, k1s, k2s, k1g, k2g, k1th, k2th, alpha_H, alpha_G, dt, sd, thd, asat)
    ...
    single_accel = a(:,robot_id); % We return the acceleration (2D) of the robot asociated to the robot_id

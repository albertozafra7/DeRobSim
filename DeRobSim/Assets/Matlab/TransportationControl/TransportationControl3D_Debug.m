function [v, U_f, U_H, u_G, U_s, u_c, U_Hd, positions, destinations, gamma_H, gamma_G, eg, es, eth, eth_individual] = TransportationControl3D_Debug(positions, destinations, kH, kG, ks, kg, kth, sd, thd, vsat)

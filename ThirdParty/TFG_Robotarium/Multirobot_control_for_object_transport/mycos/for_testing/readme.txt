mycos MATLAB .NET Assembly (.NET Component)
...
mycos_overview.html - HTML overview documentation file for the generated component. It 
                      contains the requirements for accessing the component and for 
                      generating arguments using the MWArray class hierarchy.

mycos.xml - This file contains the code comments for the mycos component classes and 
                      ...
                      online documentation for the mycos component.

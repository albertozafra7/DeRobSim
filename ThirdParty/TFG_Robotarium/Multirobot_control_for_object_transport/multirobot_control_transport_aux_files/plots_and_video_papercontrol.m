...
% if with_obstacles == 1
%     if ob_type == 1
%         plot(obstacles(1,1:5), obstacles(2,1:5), 'k-', 'LineWidth', 2, 'HandleVisibility', 'off');
%         plot(obstacles(1,6:end), obstacles(2,6:end), 'k-', 'LineWidth', 2, 'HandleVisibility', 'off');
%     else
%         plot(obstacles(1,1:4), obstacles(2,1:4), 'k-', 'LineWidth', 2, 'HandleVisibility', 'off');
%         plot(obstacles(1,5:end), obstacles(2,5:end), 'k-', 'LineWidth', 2, 'HandleVisibility', 'off');
%     end
% end
...
if make_video == 1
    create_video(folder_result, 'video_object_transport', 'robots_object_', floor(501), fps, 1, 2)
end
...
%       N should be a positive integer.
    ...
    numX = floor(width / spacing);  % Nº de filas en las que se pueden generar los robots
    numY = floor(height / spacing); % Nº de columnas en las que se pueden generar los robots
    values = randperm(numX * numY, N);  % Nº total de posiciones en las que se pueden generar los robots

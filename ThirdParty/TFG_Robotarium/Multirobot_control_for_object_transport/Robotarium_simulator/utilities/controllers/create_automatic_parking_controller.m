...
% See also CREATE_PARKING_CONTROLLER, CREATE_IS_INITIALIZED
    ...
    function dxu = automatic_parking_controller_(states, poses)
        ...
        % Coloca 0 en las filas 1 y 2 (posiciones x,y) y columnas correspondientes a los robots que ya hayan alcanzado
        % la posición final, de la matriz de velocidades dxu.
        % size(idxs,2) indica el número de columnas de idxs --> robots que han llegado a la posición deseada
    end    
end

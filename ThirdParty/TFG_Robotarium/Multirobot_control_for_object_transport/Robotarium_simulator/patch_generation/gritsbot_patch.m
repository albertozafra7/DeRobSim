...
% for a robot patch.
    ...
    shift = @(r, x, y) r + repmat([x, y, 0], size(r, 1), 1);    % A cada vértice, le suma la longitud hasta el punto deseado
    ...
    % Crea una matriz con los vectores de vértices de cada elemento del robot
    vertices = [
     body ; 
     left_wheel; 
     right_wheel;
    ...
    colors = [
     [227 66 52]/255;       % Cuerpo (naranja default - 238 138 17)
     0 0 0;                 % Rueda izq
     0 0 0;                 % Rueda drcha
     0 0 0;
     0 0 0
